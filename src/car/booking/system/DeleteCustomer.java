...
public class DeleteCustomer extends JFrame {
	...
	public DeleteCustomer() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("car/booking/system/icons/delete.png"));
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            try{
                                ResultSet rs = c.s.executeQuery("select * from customers where username = '"+c1.getSelectedItem()+"'");
                                if(rs.next()){

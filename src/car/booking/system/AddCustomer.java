...
public class AddCustomer extends JFrame {
	...
	public AddCustomer(String username) throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("car/booking/system/icons/newcustomer.jpg"));
		...
		contentPane.add(lblId);
                ...
                comboBox = new JComboBox(new String[] {"Passport", "id_card", "Driving license"});

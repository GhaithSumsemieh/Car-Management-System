...
public class BookIntercityCar extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookIntercityCar frame = new BookIntercityCar("");
	...
	public BookIntercityCar(String price) throws SQLException {
		...
		JLabel lblName = new JLabel("RENT A CAR");
		...
		contentPane.add(lblId);
                ...
                comboBox = new JComboBox(new String[] {"BMW SERIES 5", "BMW M3", "Mercedes E Class","Dacia Logan", "Hyundai ioniq", "Volvo-XC60","Mercedes S Class", "Toyota Aygo", "BMW X5", "Audi A4"});
		...
		t8.setColumns(10);
                ...
                try{
                    Conn c = new Conn();
                    ResultSet rs = c.s.executeQuery("select * from car_rental where price = '"+price+"'");
                    while(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s7 =  t5.getText();  //address
                                ...
                                String q1 = "insert into car_rental values('"+s9+"','"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s7+"','"+s8+"','"+s10+"')";
